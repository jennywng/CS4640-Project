...
(1, 2, 1, 'Blegh', 'Very small and old. Decently clean. Also if you are on the upper floors, you must go downstairs to use this bathroom as its the only woman\'s bathroom in the building', 2),
(2, 2, 1, 'Inconvenient', 'Hate how its the only one in the whole building. Also old and yucky', 2),
(3, 1, 1, 'Ew', 'Hate it', 1),
